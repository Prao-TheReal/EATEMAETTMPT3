...
public class OverlayForm : Form
{
    ...
    private readonly Dictionary<string, object> _customBoneOverrides = new()
    {
        ...
        { "Character_Nerud_CustodianEye", 1 },
        { "Char_Nerud_Barnacle_Base_C", 90 },
        { "Char_Nerud_Crab_Hatchery", 30 },
        { "Char_Nerud_Barnacle_Hatchery_C", 6 },
        { "Char_Nerud_Crab", 90 },
        { "Drzgu_hollowed", 54 },
        { "Char_Engineering_Drone_C", 6 },
        { "Character_Nerud_Abomination_C", 138 },
